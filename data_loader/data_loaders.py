...
class Med2VecDataLoader(BaseDataLoader):
    ...
    Med2Vec Dataloader
    """
    def __init__(self, data_dir, num_codes, batch_size, shuffle, validation_split, num_workers, med=True, diag=True,
                 proc=True, file_name=None, training=True, dict_format=False):
